    ...
    products: [
      {
        ...
        image: 'https://images.unsplash.com/photo-1598860237986-013eede8beae?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
        ...
        {filteredOrders.length === 0 ? (
          <Card>
            <CardContent className="py-16 text-center">
              ...
              {!searchQuery && statusFilter === 'all' && (
                <Button onClick={() => navigate('home')}>Khám phá sản phẩm</Button>
              )}
            </CardContent>
          </Card>
        ) : (
